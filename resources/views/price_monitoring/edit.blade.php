        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card  shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('price_monitoring.update',$price_monitoring) }}" autocomplete="off">
                        @csrf
                        @method('put')
                        <input type="hidden" name="id" value="{{ old('id', $price_monitoring->id) }}">
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="commodities_type" id="input-first-name"
                                    ...
                                    required value="{{old('commodities_type',$price_monitoring->commodities_type)}}"
                                    autofocus>
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="commodities_item" id="input-first-name"
                                    class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                    required value="{{old('commodities_item',$price_monitoring->commodities_item)}}"
                                    autofocus>
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="commodities_size" id="input-first-name"
                                    class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" required value="{{old('commodities_size',$price_monitoring->commodities_size)}}"
                                    autofocus>
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="price" id="price-input"
                                    class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" required value="{{old('price',$price_monitoring->price)}}"
                                    autofocus>
